...
const Agreement = (props) => {
	...
	return (
		<div className="flex items-center gap-2 max-w-[649px]">
			<input className={`
				w-8 h-8 aspect-square appearance-none border border-[#606566] rounded 
			...
			<label className='m-0 font-normal
				...
				htmlFor="agreement">Я согласен с <a className="underline" href="#">Офертой рекуррентных платежей</a> и <a className="underline" href="#">Политикой конфиденциальности</a></label>
		</div>
	)
}
